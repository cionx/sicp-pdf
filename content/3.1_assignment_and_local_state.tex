...
\begin{scheme}
(begin ~\( \dark \langle \)~~\var{\dark exp}~~\( \dark _{\mono{1}}\rangle \)~ ~\( \dark \langle \)~~\var{\dark exp}~~\( \dark _{\mono{2}}\rangle \)~ ~\( \dots \)~ ~\( \dark \langle \)~~\var{\dark exp}~~\( \dark _{\monoit{k}}\rangle \)~)
\end{scheme}
