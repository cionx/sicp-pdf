...
\footnote{
	...
	The notation is adopted from the λ-calculus, a mathematical formalism introduced by the mathematical logician Alonzo \autocite{church_calculi_lambda_conversion}.
