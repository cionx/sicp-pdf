...
\begin{scheme}
(parallel-execute ~\( \dark \langle \)~~\var{\dark p}~~\( \dark _{\mono{1}}\rangle \)~ ~\( \dark \langle \)~~\var{\dark p}~~\( \dark _{\mono{2}}\rangle \)~ ~\( \dots \)~ ~\( \dark \langle \)~~\var{\dark p}~~\( \dark _{\monoit{k}}\rangle \)~)
\end{scheme}
