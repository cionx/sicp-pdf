...
\footnote{
	...
	Common Lisp became an \acronym{ANSI} standard in 1994 (\link{ANSI 1994}).
}
...
\footnote{
	...
	This computation was made possible by new integration algorithms, a special-purpose compiler, and a special-purpose computer all implemented with the aid of software tools written in Lisp (\link{Abelson et al. 1992}; \link{Sussman and Wisdom 1992}).
}
...
\input{content/1.1_the_elements_of_programming}
\input{content/1.2_procedures_and_the_processes_they_generate}
\input{content/1.3_formulating_abstractions_with_higher_order_procedures}
