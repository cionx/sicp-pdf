...
This will force us to abandon our old substitution model of computation (\cref{Section 1.1.5}) in favor of a more mechanistic but less theoretically tractable \newterm{environment model} of computation.
