...
\end{scheme}
The implicit sequences in procedure bodies are handled by jumping to \code{ev-sequence} from \code{compound-apply}, at which point \code{continue} is already on the stack, having been saved at \code{ev-application}.
