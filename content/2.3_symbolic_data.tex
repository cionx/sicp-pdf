...
identifies the record.  For a personnel file, it might be an employee's \acronym{ID}
...
\acronym{ASCII} standard code used to represent text in computers encodes each character
