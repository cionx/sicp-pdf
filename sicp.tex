\documentclass[12pt, DIV = 7, twoside = semi, bibliography = totoc, chapterprefix = true]{scrbook}
...
\frontmatter
\include{content/coverpage.tex}
\include{content/information.tex}
\include{content/unofficial_texinfo_format.tex}
\include{content/dedication.tex}
\tableofcontents
\include{content/foreword.tex}
\include{content/preface_second_edition.tex}
\include{content/preface_first_edition.tex}
\include{content/acknowledgments.tex}

\mainmatter
\include{content/1_building_abstraction_with_procedures.tex}
\include{content/2_building_abstraction_with_data.tex}
\include{content/3_modularity_objects_and_state.tex}
\include{content/4_metalinguistic_abstraction.tex}
\include{content/5_computing_with_register_machines.tex}

\backmatter
\include{content/references.tex}
\printbibliography
%\include{content/list_of_exercises.tex}
\include{content/list_of_figures.tex}
\include{content/index.tex}
